...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        //루트 경로 정의
        GlobalConst.ROOT_PATH = "/home/lks21c/repo/Neulearn-AI_Agent/datas/";
        GlobalConst.WORD2VEC_CORPUS_PATH = GlobalConst.ROOT_PATH + "tmps/corpusRaws.txt";
        GlobalConst.CORPUS_FOLDER_PATH = GlobalConst.ROOT_PATH + "corpus";
        GlobalConst.ANN_PATH = GlobalConst.ROOT_PATH + "tmps/ann.bin";
        GlobalConst.FUNCLIST_PATH = GlobalConst.ROOT_PATH + "tmps/funclist.bin";
        GlobalConst.SENTENCE_TO_FUNC_CORPUS_PATH = GlobalConst.ROOT_PATH + "senToFuncCorpus.txt";
